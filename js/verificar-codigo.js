// Lógica para verificar código de recuperación de clientes
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('http://localhost:5000/api/clientes/verificar-codigo', {
            method: 'POST',
        ...
        .then(data => {
            if (data.message) {
                window.location.href = 'nueva-password.html?email=' + encodeURIComponent(email) + '&codigo=' + code;
            } else {
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
